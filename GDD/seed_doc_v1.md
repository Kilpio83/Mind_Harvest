...
- Each patient carries a specific desire, compulsion, or "quirk" that functions as a mirror to a different facet of the protagonist's buried self. Those quirks are also reflected in the characters archetypes.

### Retention Mechanic
Patient routes are player-driven:
- If a patient's particular dynamic **resonates** — the player leans in, the sessions deepen, new content unlocks, the patient stays longer and pulls the protagonist further
...
This means the game self-selects. Players naturally follow the routes that match their own itch. The protagonist's journey is shaped by which mirrors he chooses to keep looking into. 

Going far enough with a particular patient will add an additional layer to the protagonist. It will influence his future gialogue options. For example mastering the power dynamics fetish will let protagonist use this knowladge in the future.

### Patient Design Principle
Each patient should:
- Be a fully realized person, not a kink delivery system
- Have her own reasons for being in therapy that are separate from her effect on the protagonist
- Push the protagonist in a specific psychological direction
- Carry enough humor, warmth, or strangeness to fit the tone
- Partients should be distinct, represent particular archetypes
...
The true self protagonist doscovers with his patients will influence his relationship with Bea.
...
- Surprise is a core experience — the player should regularly not know what they feel about what just happened, tilt they head and say "WTF just happened?"
...
- [ ] Specific backgrounds for each character creation option — what exactly changes?
...
- [ ] Engine (Ren'Py assumed based on video reference)

---

*Version 1.0 — Generated from initial development sessions*
